        ...
        <div className="content-card">
          <div className="text-center mb-8">
            <motion.div
              ...
              className="mb-4"
            >
              <div className="w-14 h-14 rounded-2xl flex items-center justify-center mx-auto" style={{ background: 'rgba(168,85,247,0.1)' }}>
                <svg className="w-7 h-7" style={{ color: '#a855f7' }} fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" />
                </svg>
              </div>
            </motion.div>
            <h1 className="text-xl font-bold gradient-text">Create Account</h1>
            <p className="text-xs mt-1" style={{ color: 'var(--text-secondary)' }}>Start your journey together</p>
          </div>
          ...
          <p className="text-center text-xs mt-5" style={{ color: 'var(--text-tertiary)' }}>
            ...
            <Link to="/login" className="font-medium transition-colors duration-200" style={{ color: '#ec4899' }}>Login</Link>
          </p>
        </div>
      </motion.div>
    </div>
